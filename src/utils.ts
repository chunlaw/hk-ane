export const setSeoHeader = ({
  ...
  document
    ...
    ?.setAttribute(
      "href",
      `https://ane-hk.chunlaw.io${window.location.pathname}`,
    );
  ...
  document
    ...
    ?.setAttribute(
      "href",
      "https://ane-hk.chunlaw.io" +
        window.location.pathname.replace(`/${lang}`, "/en"),
    );
  document
    ...
    ?.setAttribute(
      "href",
      "https://ane-hk.chunlaw.io" +
        window.location.pathname.replace(`/${lang}`, "/zh"),
    );
  document
